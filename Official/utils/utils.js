...
function autoFill(){
    ...
    var comment1 = {author:users[0].userId, description:"Hi, this is a nice speaker!", posthash:"12345", datetime:new Date()};
    var comment2 = {author:users[2].userId, description:"A cheap phone, nice!", posthash:"42069", datetime:new Date()};
    var comment3 = {author:users[1].userId, description:"I'd like to buy 1", posthash:"61619112", datetime:new Date()};
    var comment4 = {author:users[2].userId, description:"Take my moneyyyy", posthash:"61619111", datetime:new Date()};
    var comment5 = {author:users[3].userId, description:"Ahhhhhh", posthash:"61619111", datetime:new Date()};
    var comment6 = {author:users[4].userId, description:"DLSU Animo Lasalle", posthash:"61619111", datetime:new Date()};
    var comment7 = {author:users[1].userId, description:"Animo Lasalle", posthash:"61619112", datetime:new Date()};
    var comment8 = {author:users[2].userId, description:"WHOOOOOOO Finally!!!!", posthash:"61619112", datetime:new Date()};
    var comment9 = {author:users[2].userId, description:"Time to beat the summer heat for my kids!", posthash:"74547", datetime:new Date()};
    var comment10 = {author:users[3].userId, description:"Mine broke after just a few uses :(", posthash:"78695", datetime:new Date()};
    var comment11 = {author:users[2].userId, description:"The seller was rude when I was trying to place an order", posthash:"78695", datetime:new Date()};
    var comment12 = {author:users[4].userId, description:"Just placed an order for this! TY", posthash:"16334", datetime:new Date()};
    var comment13 = {author:users[1].userId, description:"Is this really better than the OG frying with oil???", posthash:"16334", datetime:new Date()};
    var comment14 = {author:users[2].userId, description:"Aw man, the black one is sold out...", posthash:"16334", datetime:new Date()};
